...
(3, 'Jonel Reyes', 'jonel.reyes@example.com', '$2b$10$q7.dnX03mhSsAMUEqMpKz.d9MelOWpvo8b6wpapxwlmk79AMAR0Ue', 'customer', 'active', NOW(), NOW()),
(4, 'Maria Santos', 'maria.santos@example.com', '$2b$10$q7.dnX03mhSsAMUEqMpKz.d9MelOWpvo8b6wpapxwlmk79AMAR0Ue', 'customer', 'active', NOW(), NOW()),
(5, 'Carlo Dizon', 'carlo.dizon@example.com', '$2b$10$q7.dnX03mhSsAMUEqMpKz.d9MelOWpvo8b6wpapxwlmk79AMAR0Ue', 'customer', 'active', NOW(), NOW());
-- Password for Jonel/Maria/Carlo is: customer123
...
-- Original 2 sample orders (user 2)
INSERT INTO `transactions` (`id`, `user_id`, `status`, `total_price`, `createdAt`, `updatedAt`) VALUES
(1, 2, 'completed', 3300.00, NOW(), NOW()),
(2, 2, 'pending', 3500.00, NOW(), NOW());

-- 6 more orders (2 per new user), spread across different dates in the last month,
-- mixed statuses, and different products so the admin dashboard charts (bar/line/pie)
-- all have real data to show instead of being empty.
INSERT INTO `transactions` (`id`, `user_id`, `status`, `full_name`, `address`, `city`, `zip`, `total_price`, `payment_method`, `createdAt`, `updatedAt`) VALUES
(3, 3, 'completed', 'Jonel Reyes', '123 Kalayaan Ave', 'Quezon City', '1100', 2600.00, 'card', '2026-06-10 14:23:00', '2026-06-10 14:23:00'),
(4, 3, 'pending',   'Jonel Reyes', '123 Kalayaan Ave', 'Quezon City', '1100', 3500.00, 'cash', '2026-06-25 09:05:00', '2026-06-25 09:05:00'),
(5, 4, 'completed', 'Maria Santos', '45 Rizal St', 'Makati City', '1200', 2700.00, 'card', '2026-06-18 17:40:00', '2026-06-18 17:40:00'),
(6, 4, 'shipped',   'Maria Santos', '45 Rizal St', 'Makati City', '1200', 3500.00, 'card', '2026-07-01 11:12:00', '2026-07-01 11:12:00'),
(7, 5, 'completed', 'Carlo Dizon', '78 Bonifacio Rd', 'Pasig City', '1600', 2700.00, 'cash', '2026-06-30 20:15:00', '2026-06-30 20:15:00'),
(8, 5, 'cancelled',  'Carlo Dizon', '78 Bonifacio Rd', 'Pasig City', '1600', 2200.00, 'card', '2026-07-03 13:50:00', '2026-07-03 13:50:00');
...
(2, 1, 3, 1, 1500.00, NOW(), NOW()),
(3, 2, 2, 1, 3500.00, NOW(), NOW()),
-- Order 3 (Jonel, completed, 2026-06-10): T-Shirt + Beanie
(4, 3, 1, 1, 1800.00, '2026-06-10 14:23:00', '2026-06-10 14:23:00'),
(5, 3, 12, 1, 800.00, '2026-06-10 14:23:00', '2026-06-10 14:23:00'),
-- Order 4 (Jonel, pending, 2026-06-25): Hoodie
(6, 4, 2, 1, 3500.00, '2026-06-25 09:05:00', '2026-06-25 09:05:00'),
-- Order 5 (Maria, completed, 2026-06-18): Vinyl Box Set + Framed Poster
(7, 5, 4, 1, 1500.00, '2026-06-18 17:40:00', '2026-06-18 17:40:00'),
(8, 5, 11, 1, 1200.00, '2026-06-18 17:40:00', '2026-06-18 17:40:00'),
-- Order 6 (Maria, shipped, 2026-07-01): Battle Jacket
(9, 6, 8, 1, 3500.00, '2026-07-01 11:12:00', '2026-07-01 11:12:00'),
-- Order 7 (Carlo, completed, 2026-06-30): Guitar Strap + Coffee Mug + Wristband Set
(10, 7, 6, 1, 1000.00, '2026-06-30 20:15:00', '2026-06-30 20:15:00'),
(11, 7, 7, 1, 800.00, '2026-06-30 20:15:00', '2026-06-30 20:15:00'),
(12, 7, 10, 1, 900.00, '2026-06-30 20:15:00', '2026-06-30 20:15:00'),
-- Order 8 (Carlo, cancelled, 2026-07-03): Silver Chain
(13, 8, 19, 1, 2200.00, '2026-07-03 13:50:00', '2026-07-03 13:50:00');
